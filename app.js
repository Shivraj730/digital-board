...
/* ============================================================
   DIGITAL BOARD AUTO SCALING
   BASE SIZE: 1920 × 1080
   ============================================================ */

function scaleDigitalBoard() {
    ...
    /*
       X र Y दुवैबाट scale निकाल्ने।
       सानो scale रोज्दा पूरा board screen भित्र बस्छ।
    */
    ...
    */
    ...
    /*
       Screen मा board लाई center गर्ने।
    */
    ...
    board.style.left =
        ${(screenWidth - boardWidth) / 2}px;

    board.style.top =
        ${(screenHeight - boardHeight) / 2}px;
}
